...
Check performed at Tue Jan 31 10:59:23 CET 2023      </nav>
    </div>
  </header>
...
<span class="location"><a href="../../lint-baseline.xml">../../lint-baseline.xml</a></span>: <span class="message">3 errors/warnings were listed in the baseline file (lint-baseline.xml) but not found in the project; perhaps they have been fixed? Another possible explanation is that lint recently stopped analyzing (and including results from) dependent projects by default. You can turn this back on with <code>android.lintOptions.checkDependencies=true</code>. Unmatched issue types: DefaultLocale, StaticFieldLeak (2)</span><br />
<span class="location"><a href="../../lint-baseline.xml">../../lint-baseline.xml</a></span>: <span class="message">9 errors were filtered out because they are listed in the baseline file, lint-baseline.xml<br/>
</span><br />
</div>
